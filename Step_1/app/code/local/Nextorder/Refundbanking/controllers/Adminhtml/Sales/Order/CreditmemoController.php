...
class Nextorder_Refundbanking_Adminhtml_Sales_Order_CreditmemoController extends Mage_Adminhtml_Sales_Order_CreditmemoController
{
    /**
...
//        Mage::log( "Rewrite Works", null, 'xulin.log');
        ...
        try {
            ...
            if ($creditmemo) {
                ...
                $creditmemo->getOrder()->addStatusToHistory('closed', 'Refund ist abgewickelt', false)->save();
